...
export function Dashboard({ items, onItemClick, onAddStock, onStockIn, onStockOut }: DashboardProps) {
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="grid grid-cols-2 gap-3">
            <Button onClick={onStockIn} variant="default" className="bg-green-600 hover:bg-green-700 h-14 text-base">
              <ArrowDownToLine className="w-5 h-5 mr-2" />
              <span>Stock In</span>
            </Button>
            <Button onClick={onStockOut} variant="default" className="bg-red-600 hover:bg-red-700 h-14 text-base">
